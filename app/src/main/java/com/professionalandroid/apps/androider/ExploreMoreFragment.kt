...
class ExploreMoreFragment() : Fragment() {
    ...
    val adapter=ExploreRankingAdapter(makeList())
    ...
    private fun moveToFragment(newFragment:Fragment){
        requireActivity().supportFragmentManager.beginTransaction().setCustomAnimations(R.anim.start_more_view,R.anim.left_view,R.anim.right_view,R.anim.end_more_view)
    ...
    private fun setRecyclerView(view:View){
        ...
        adapter.setRankingClickListener(object: ExploreRankingAdapter.OnRankingClickListener{
    ...
    private fun makeList():ArrayList<ExploreRanking>{
        ...
        for(i in 2..20) list.add(ExploreRanking(R.drawable.bread,"김영민","@루삥뽕","저는 쌉게이입니다.","100"))
        return list
    }
