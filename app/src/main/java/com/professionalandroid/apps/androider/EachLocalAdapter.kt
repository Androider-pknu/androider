...
class EachLocalAdapter(val list:ArrayList<EachLocal>) : RecyclerView.Adapter<EachLocalAdapter.CustomViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EachLocalAdapter.CustomViewHolder {
    ...
    override fun onBindViewHolder(holder: EachLocalAdapter.CustomViewHolder, position: Int) {
