...
class PlaceFrag():Fragment(){
    ...
    private fun setLocationButton(view:View){
        view.local_search_btn.setOnClickListener {
            val nextIntent= Intent(requireContext(),PlaceSearch::class.java)
    ...
    private fun setRecyclerView1(view:View){
        ...
        storeAdapter.setItemImageClickListener(object: ItemImageButtonAdapter.OnItemImageClickListener{
