...
class SocialRankingAdapter(val list:ArrayList<SocialRanking>) : RecyclerView.Adapter<SocialRankingAdapter.CustomViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SocialRankingAdapter.CustomViewHolder {
    ...
    override fun onBindViewHolder(holder: SocialRankingAdapter.CustomViewHolder, position: Int) {
